...
const OAuthCodeModel = Sequelize.define('oauth_code', {
  ...
  authorizationCode: { type: Seq.STRING, field: 'authorization_code' },
  expiresAt: { type: Seq.DATE, field: 'expires_at' },
  redirectUri: { type: Seq.STRING, field: 'redirect_uri' },
  scope: { type: Seq.STRING, field: 'scope' },
  clientID: { type: Seq.STRING, field: 'client_id' },
  userID: { type: Seq.STRING, field: 'user_id' },
...
const OAuthTokenModel = Sequelize.define('oauth_token', {
  ...
  accessToken: { type: Seq.STRING, field: 'access_token' },
  accessTokenExpiresAt: { type: Seq.DATE, field: 'access_token_expires_at' },
  refreshToken: { type: Seq.STRING, field: 'refresh_token' },
