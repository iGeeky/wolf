...
* AI による書き込み操作はすべて `appID = 'ai-agent'` で `access_log` テーブルに記録され、人手による操作と明確に区別され、完全に監査可能
* 詳細：[AI アシスタント概要](./README-AI-AGENT-EN.md) · [AI アシスタント利用ガイド](./docs/ai-agent.md)
...
[AI アシスタント概要](./README-AI-AGENT-EN.md)

[AI アシスタント利用ガイド](./docs/ai-agent.md)
